/*
 * @Author: Peak Xin 
 * @Date: 2020-04-19 13:58:40 
 * @Last Modified by: Peak Xin
 * @Last Modified time: 2020-04-19 22:17:29
 */
...
var page = {
    ...
    , formValidate: function (formData) {
        ...
        // 验证邮箱格式
        if (!_xm.validate(formData.email, 'email')) {
            result.msg = '邮箱格式不正确';
            return result;
        }
        // 验证密码提示问题是否为空
        if (!_xm.validate(formData.question, 'require')) {
            result.msg = '密码提示问题不能为空';
            return result;
        }
        // 验证密码提示问题答案是否为空
        if (!_xm.validate(formData.answer, 'require')) {
